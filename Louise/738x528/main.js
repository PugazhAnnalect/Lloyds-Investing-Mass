...
function animate() {
  ...
  // Frame 3
    ...
    .to(['#legal'], { autoAlpha:0, left:'0'},'frame3-=.0.4')
    ...
    .to(['#horse'], 1, { left: '340px', autoAlpha: 1, ease: "power1.inOut", yoyo: true }, 'frame3+=.6')
    .to(['#logo_text'], 1, { left: '306px', autoAlpha: 1, ease: "power1.inOut", yoyo: true }, 'frame3+=.7')
